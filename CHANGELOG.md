...
- **core,data-source:** 多个页面片容器引用同一个页面片时,其他有未渲染的页面片容器时会导致数据源编译后数据无法更新 ([0bbafa1](https://github.com/Tencent/tmagic-editor/commit/0bbafa153d220f017ca634f13a9cf4379da30bd9))

### Features

- **core:** runDataSourceMethod 返回 await 方法的执行结果 ([92bd5cf](https://github.com/Tencent/tmagic-editor/commit/92bd5cf942e2686711fe17fe15eea47632f5180b))
- **editor,form:** 支持按需设置表单组件 ([c79034b](https://github.com/Tencent/tmagic-editor/commit/c79034befc620a90dc0452e8ae6fb2e9d40b17e5))
